...
export default function DeedDetailsBuyer({
  ...
  const [currentPage, setCurrentPage] = useState<'main' | 'request'>('main');
  ...
  return (
    <>
        ...
        (status == 'pending' ||
          ...
          <div className='flex h-screen w-screen flex-col items-start justify-start gap-y-5 overflow-x-hidden bg-[#F8F8F8] p-4'>
              ...
              {status != 'pending' && (
                <>
                  <div className='flex w-full flex-col gap-y-2'>
                    <div className='flex w-full justify-between text-[#5D5D5D]'>
                      <p>Deed Seller</p>
                      <p className='text-[#52B9FF]'>{deed?.seller_id}</p>
                    </div>
                  </div>
                  <div className='bg-[#EDEDED] p-[0.5px]'></div>
                </>
            ...
            <div className='flex min-h-[120px] w-full gap-2'>
              ...
              {/* In progess - Request fund, Report fraud btn */}
              {status == 'in_progress' && (
                <>
                  <div className='w-1/2'>
                    <Button
      ...
      {
        // ---------- Request page ------------------
        currentPage == 'request' && <RequestFunds deed={deed} />
      }
    </>
  );
}
